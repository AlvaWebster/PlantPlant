 ...
 * Author: alvaj
 * Function: To create needed IO pin defintions for use in main program
...
void Init(void);            //initialize global pin definitions
void setRelayO(void);       //set relay output ports
